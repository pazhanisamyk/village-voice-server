...
router.get('/getAll-user/complaint', authenticateUser, isAdmin, getAllUserComplaint); 
...
router.put('/update-user/complaint', authenticateUser, isAdmin, updateComplaintStatus); 
